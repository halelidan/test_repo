...
2. Click <walkthrough-spotlight-pointer cssSelector=".mdc-button.mat-mdc-button.gmat-mdc-button-with-prefix">**ENABLE APIS AND SERVICES**</walkthrough-spotlight-pointer> to continue.
